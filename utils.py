...
def seed_services(employee_manager, leave_manager, meeting_manager, ticket_manager):
    ...
    employees_data = [
        # Leadership
        {
            ...
            "name": "Tony Stark",
            "manager_id": None,
            "email": "tony.stark@zerotinf.com",
        },
        {
            "emp_id": "E002",
            "name": "Steve Rogers",
            "manager_id": None,
            "email": "steve.rogers@zerotinf.com",
        },
        # Engineering team under Tony Stark
        {
            "emp_id": "E003",
            "name": "Peter Parker",
            "manager_id": "E001",
            "email": "peter.parker@zerotinf.com",
        },
        {
            "emp_id": "E004",
            "name": "Black Widow",
            "manager_id": "E003",
            "email": "black.widow@zerotinf.com",
        },
        {
            "emp_id": "E005",
            "name": "Vision",
            "manager_id": "E003",
            "email": "vision@zerotinf.com",
        },
        # Product team under Steve Rogers
        {
            "emp_id": "E006",
            "name": "Black Panther",
            "manager_id": "E002",
            "email": "black.panther@zerotinf.com",
        },
        {
            "emp_id": "E007",
            "name": "Wanda Maximoff",
            "manager_id": "E006",
            "email": "wanda.maximoff@zerotinf.com",
        },
        {
            "emp_id": "E008",
            "name": "Bucky Barnes",
            "manager_id": "E006",
            "email": "bucky.barnes@zerotinf.com",
        },
    ]
        ...
        for i in range(num_leaves):
            ...
            if random.random() > 0.7:  # 30% chance of multi-day leave
                for j in range(1, random.randint(2, 5)):  # 1-4 additional days
                    ...
                    consecutive_entry = {
                        "history_id": len(
                            leave_manager.employee_leaves[emp_id]["history"]
                        )
                        + 1,
                        "emp_id": emp_id,
                    ...
                    leave_manager.employee_leaves[emp_id]["history"].append(
                        consecutive_entry
                    )
    ...
    for employee in employees_data:
        ...
        for i in range(num_meetings):
            ...
            potential_attendees = [
                e["emp_id"] for e in employees_data if e["emp_id"] != emp_id
            ]
    ...
    return {
        ...
        "leave_records": sum(
            len(data["history"]) for data in leave_manager.employee_leaves.values()
        ),
        "meetings": sum(
            len(meetings) for meetings in meeting_manager.meetings.values()
        ),
...
if __name__ == "__main__":
    ...
    result = seed_services(
        employee_manager, leave_manager, meeting_manager, ticket_manager
    )
